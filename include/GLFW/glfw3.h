 ...
 *  @endcode
 *
 *  @param[in] error_code An [error code](@ref errors).  Future releases may put
 *  more error codes.
 ...
 *  keys, it is typically the diacritic it would put to a character.
 *
